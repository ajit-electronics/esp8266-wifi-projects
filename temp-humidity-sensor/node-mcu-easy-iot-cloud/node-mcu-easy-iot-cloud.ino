...
// change those lines
#define AP_USERNAME "nereusiphone"
#define AP_PASSWORD "ajit1234"
#define INSTANCE_ID "58df713047976c4e831cb691"
...
struct StoreStruct {
  ...
  CONFIG_VERSION,
  // token
  "5SpmyUqPgNWGBEMS3bGI5J6rXDwAtW4FRCRZvkcN",
...
void setup() {
    ...
    eiotcloud.begin(AP_USERNAME, AP_PASSWORD,  storage.token);
